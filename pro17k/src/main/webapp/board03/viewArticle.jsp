...
<body>
	<form name="frmArticle" method="post" enctype="multipart/form-data">
		<table border="0" align="center">
			<tr>
				<td width="150" align="center" bgcolor="#FF9933">글번호
...
<tr>
	...
	<tr>
	 <td width=150"
					align="center" bgcolor="#FF9933"> 제목</td>
			...
			<c:if
				...
				<tr>
					...
					<td><input type="hidden" name="oridinalFileName"
  ...
  <tr id="tr_btn_modify">
  	<td colspan="2" align="center">
  		<input type=button value="수정하기" onClick="fn_modify_article(frmAarticle)">
